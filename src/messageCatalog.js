const BASE_MESSAGE_CATALOG = [
  {
    ...
    defaultTitle: 'Chegou um novo acerto por aqui',
  ...
  },
  {
    ...
    defaultBody: '{descricao} está no radar de hoje com {valor}.',
    variables: [
  ...
  },
  {
    ...
    defaultBody: '{descricao} está marcado para hoje com {valor}.',
    variables: [
      { name: 'descricao', required: true, fields: ['title', 'body'] },
      { name: 'valor', required: true, fields: ['body'] }
    ]
